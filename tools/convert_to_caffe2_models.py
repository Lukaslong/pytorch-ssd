...
model_path = f"output/{net_type}.onnx"
init_net_path = f"output/{net_type}_init_net.pb"
init_net_txt_path = f"output/{net_type}_init_net.pbtxt"
predict_net_path = f"output/{net_type}_predict_net.pb"
predict_net_txt_path = f"output/{net_type}_predict_net.pbtxt"
